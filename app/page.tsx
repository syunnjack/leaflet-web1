...
export default function Home(){
 ...
 return <main><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"WebSite",name:"MAPPIN","description":"近くの場所・イベント・サービスを地図と口コミで比較できる地域ポータル"})}}/>
 <header><a className="logo" href="#top"><b>M</b>MAPPIN<span>近くのいい場所、すぐ見つかる。</span></a><nav><a href="#discover">探す</a><a href="#business">掲載する</a><a href="#about">運営方針</a></nav><button className="post">＋ スポットを投稿</button></header>
 ...
 <footer><div className="logo"><b>M</b>MAPPIN</div><p>場所選びを、もっと早く、もっと確かに。</p><nav><a href="#discover">スポット検索</a><a href="#business">事業者向け</a><a href="#about">編集方針</a></nav><small>© 2026 MAPPIN MVP. Map data © OpenStreetMap contributors.</small></footer></main>;
}
